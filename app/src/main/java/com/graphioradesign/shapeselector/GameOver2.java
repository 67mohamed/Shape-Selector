...
public class GameOver2 extends ActionBarActivity {

    SharedPreferences prefs;
    int experienceScore;
    String message;

    GameScreen2 gameScreen = new GameScreen2();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(gameScreen.returnScore()>Integer.parseInt(prefs.getString("highScore2", "0"))){
            editor.putString("highScore2", gameScreen.returnScoreString());
        ...
        highScoreTextView.setText("High Score  "+ prefs.getString("highScore2", "0"));
        experienceTextView.setText("XP                "+ Integer.toString(prefs.getInt("XP",0)));
        gameScreen.stopTimer();
        message = "I just played Survival Mode on The Shape Challenge and got a score of "+ gameScreen.returnScoreString()+". High Score: "
                +prefs.getString("highScore2", "0")+". Experience Points: "+Integer.toString(prefs.getInt("XP",0))+". Can you beat that?";
        ...
        RelativeLayout relative = (RelativeLayout) findViewById(R.id.GameOverLayout);
        relative.setBackgroundColor(color);

        Button button = (Button) findViewById(R.id.restartGame);
        button.setBackgroundColor(colorSmall);
