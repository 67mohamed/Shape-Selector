...
public class GameScreen2 extends ActionBarActivity {
    String mainImage = "ic_launcher";
    static int score = 0;
    int countDownTimerView = 5;
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countDown = new CountDownTimer(6000000, 100) {

            public void onTick(long millisUntilFinished) {

                if(Math.abs(holder-millisUntilFinished)>=speed){
                    ...
                    timer.setText(Integer.toString(countDownTimerView));
                    if(countDownTimerView<=0){

                        gameOver();
                    }
                    holder = millisUntilFinished;
    ...
    public void gameOver(){
        Intent intent = new Intent(this, GameOver2.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_game_screen2, menu);
        return true;
    }
